...
class Application(TimestampMixin, Base):
    ...
    ai_score = relationship("AIScore", back_populates="application", uselist=False, passive_deletes=True)
    interviews = relationship("Interview", back_populates="application", passive_deletes=True)
    contracts = relationship("Contract", back_populates="source_application", passive_deletes=True)
